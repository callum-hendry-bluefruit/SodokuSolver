...
TEST(testSodokuSolver, remove_numbers_from_array_based_on_first_row_of_m_sodoku_grid_after_accepting_CSV_values)
{
	SodokuSolverClass removeNumbers;
	std::array<int, 9> expected_possible_numbers_array = { 0, 2, 0, 4, 5, 6, 0, 8, 9 };

	removeNumbers.m_remove_possible_numbers_by_row();
